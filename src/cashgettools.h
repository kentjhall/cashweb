...
#define CWG_CALL_ID_NO CW_SYS_ERR+1
#define CWG_IN_DIR_NO CW_SYS_ERR+2
#define CWG_IS_DIR_NO CW_SYS_ERR+3
#define CWG_FETCH_NO CW_SYS_ERR+4
#define CWG_METADATA_NO CW_SYS_ERR+5
#define CWG_SCRIPT_REV_NO CW_SYS_ERR+6
#define CWG_SCRIPT_NO CW_SYS_ERR+7
#define CWG_CIRCLEREF_NO CW_SYS_ERR+8
#define CWG_FETCH_ERR CW_SYS_ERR+9
#define CWG_WRITE_ERR CW_SYS_ERR+10
#define CWG_SCRIPT_ERR CW_SYS_ERR+11
#define CWG_SCRIPT_RETRY_ERR CW_SYS_ERR+12
#define CWG_FILE_ERR CW_SYS_ERR+13
#define CWG_FILE_LEN_ERR CW_SYS_ERR+14
#define CWG_FILE_DEPTH_ERR CW_SYS_ERR+15
